...
public class HudiTrinoFromUnixFunctionExpression
        extends HudiTrinoFunctionExpression
{
    static final String TRINO_FN_NAME = "from_unixtime";

    private static final String HUDI_FN_NAME = "from_unixtime";
    ...
    public boolean canUseIndex(HoodieIndexDefinition indexDefinition)
    {
        ...
        if (getChildren().getFirst() instanceof NameReference argNameRef) {
            ...
            // Function does not accept arguments, do not need to check them
        }
