...
public class HudiTrinoYearFunctionExpression
        extends HudiTrinoFunctionExpression
{
    static final String TRINO_FN_NAME = "year";

    private static final String HUDI_FN_NAME = "year";

    public HudiTrinoYearFunctionExpression(List<Expression> arguments, Type returnType)
    {
