...
public class IndexSupportFactory
{
            ...
            HoodieTableMetaClient metaClient, HoodieTableMetadata metadataTable, TupleDomain<HiveColumnHandle> tupleDomain, ConnectorSession session)
    {
        ...
        List<StrategyProvider> strategyProviders = List.of(
                ...
                new StrategyProvider(() -> isColumnStatsIndexEnabled(session), () -> new HudiColumnStatsIndexSupport(metaClient, metadataTable, tupleDomain)),
            ...
            HoodieTableMetaClient metaClient, HoodieTableMetadata metadataTable, TupleDomain<HiveColumnHandle> tupleDomain, ConnectorSession session)
    {
        StrategyProvider partitionStatsStrategy = new StrategyProvider(
                () -> isPartitionStatsIndexEnabled(session), () -> new HudiPartitionStatsIndexSupport(metaClient, metadataTable, tupleDomain));
