        ...
        implements ConnectorTableHandle
{
    ...
    private final Lazy<Schema> hudiTableSchema;
    // Coordinator-only
    ...
    {
        this(Optional.empty(), Optional.empty(), schemaName, tableName, basePath, tableType, partitionColumns, ImmutableSet.of(), partitionPredicates, regularPredicates, Lazy.lazily(() -> new Schema.Parser().parse(tableSchemaStr)));
    }
            ...
            Lazy<Schema> hudiTableSchema)
    {
        ...
        this.hudiTableSchema = hudiTableSchema;
    }
    ...
    {
        return hudiTableSchema.get().toString();
    }

    @JsonIgnore
    public Schema getTableSchema()
    {
        return hudiTableSchema.get();
    }
